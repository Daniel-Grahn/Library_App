...
public class UserDaoTest {
    ...
    //potenialy test what happens if we do not have a SQLException  

    // @Test
    // void getNonExistingUserIfNoConnection() throws SQLException {
    //     final String username = "testuser";
    //     DataSource fds = mock(DataSource.class);
    //     UserDao userDao = new UserDao(fds);

    //     assertThatExceptionOfType(SQLException.class).isThrownBy(() -> userDao.get(username));
